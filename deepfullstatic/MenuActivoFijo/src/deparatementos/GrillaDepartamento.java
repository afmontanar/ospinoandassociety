 ...
 */
public class GrillaDepartamento extends javax.swing.JDialog {
Object poder;
    ModelosTabla tm;
    /**
     * Creates new form GrillaArea
     */
    public GrillaDepartamento(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
         String[] columnas = {"codedepartamento","namedepartamento"};
        this.tm = new ModelosTabla(columnas, jTable1, "partamento");
        jTable1.setModel(tm);
...
{  int sw=0;
 ...
 try 
{
  ResultSet resultado1 = Producto.c.MysqlConsulta("select codedepartamento,namedepartamento from partamento where  namedepartamento like'%"+jTextField1.getText()+"%'");

  while(resultado1.next()) // va avanzando de UN(1) cliente.
{
String[] columnas= {resultado1.getString("codedepartamento"), resultado1.getString("namedepartamento")};
 tm.ingresarUsuario(columnas);
sw=1;
} 
if(sw==0)                 
{
JOptionPane.showMessageDialog(this, "NO existe el Departamento");
...
public void enviar() {
        try {
            ...
            ResultSet resultado1 = Colassdepa.c.MysqlConsulta("select codedepartamento,namedepartamento from partamento  where codedepartamento='" + jTable1.getValueAt(selectedRow, 0).toString() + "'");
            if (resultado1.next()) {
                Departamentos.name.setText(resultado1.getString("namedepartamento"));
                Departamentos.code.setText(resultado1.getString("codedepartamento"));
                this.poder = ClasArea.are.get("depar");
...
public void thesecretsoul(){
                    int selectedRow = jTable1.getSelectedRow();
RegistrosResponsables.jTextField5.setText(jTable1.getValueAt(selectedRow, 0).toString());
RegistrosResponsables.jLabel3.setText(jTable1.getValueAt(selectedRow, 1).toString());
 }
    /**
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       Departamentos.code.setEnabled(true);
        this.poder = ClasArea.are.get("depar");
        JDialog pu = (JDialog) this.poder;
        pu.setVisible(true);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
       Departamentos.code.setEnabled(false);
        enviar();
   ...
   center();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GrillaDepartamento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                GrillaDepartamento dialog = new GrillaDepartamento(new javax.swing.JFrame(), true);
