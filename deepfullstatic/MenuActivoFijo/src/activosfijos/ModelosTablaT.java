 ...
 */
 ...
 public class ModelosTablaT extends AbstractTableModel{
...
//otras funciones miembro
    ...
    public void setUsuarios(List<Object[]> usuarios) {
        ...
        public ModelosTablaT(String[] TitleColums, JTable jTable1, String tabla) {          
            ...
            Statement sentencia;
            Connection Conec = (Connection) DriverManager.getConnection(("jdbc:mysql://localhost:3306/" + "deepfullstatic"), "root", "1988");
...
//                    String n[] = {Consulta.getString("nombre"), Consulta.getString("apellido"), Consulta.getString("saldo"), Consulta.getString("estado"), Consulta.getString("cupo")};
                ...
                Logger.getLogger(ModelosTablaT.class.getName()).log(Level.SEVERE,null, ex);
            }
        }

    public ModelosTablaT(ArrayList<Object[]> usua, String[] TitleColums, JTable jTable1) {
        this.usua = usua;
        this.TitleColums = TitleColums;
        this.jTable1 = jTable1;
        this.numberColumn = TitleColums.length;
...
//    }
    ...
    public ModelosTablaT(String[] columnas, JTable jTable1) {
        this.usuarios = new LinkedList<Object[]>();       
