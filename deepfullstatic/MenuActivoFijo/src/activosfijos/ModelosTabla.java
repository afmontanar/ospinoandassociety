 ...
 */
 ...
 public class ModelosTabla extends AbstractTableModel implements Cloneable{
...
//                    String n[] = {Consulta.getString("nombre"), Consulta.getString("apellido"), Consulta.getString("saldo"), Consulta.getString("estado"), Consulta.getString("cupo")};
                ...
                Logger.getLogger(ModelosTabla.class.getName()).log(Level.SEVERE,null, ex);
            }
        }

    public ModelosTabla(ArrayList<Object[]> usua, String[] TitleColums, JTable jTable1) {
        this.usua = usua;
        this.TitleColums = TitleColums;
        this.jTable1 = jTable1;
        this.numberColumn = TitleColums.length;
...
//    }
    ...
    public ModelosTabla(String[] columnas, JTable jTable1) {
        this.usuarios = new LinkedList<Object[]>();       
