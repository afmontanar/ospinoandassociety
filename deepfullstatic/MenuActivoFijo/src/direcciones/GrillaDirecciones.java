 ...
 */
public class GrillaDirecciones extends javax.swing.JDialog {
Object poder;
    ModelosTabla tm;
    /**
     * Creates new form GrillaArea
     */
    public GrillaDirecciones(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
         String[] columnas = {"codedireccion","namedireccion"};
        this.tm = new ModelosTabla(columnas, jTable1, "direccion");
        jTable1.setModel(tm);
...
public void enviar() {
        try {
            ...
            ResultSet resultado1 = Direcciones.c.MysqlConsulta("select codedireccion,namedireccion from direccion  where codedireccion='" + jTable1.getValueAt(selectedRow, 0).toString() + "'");
            if (resultado1.next()) {
                RegistroDirecciones.name.setText(resultado1.getString("namedireccion"));
                RegistroDirecciones.code.setText(resultado1.getString("codedireccion"));
                this.poder = ClasArea.are.get("regdirecc");
 ...
 public void thesecretsoul(){
                    int selectedRow = jTable1.getSelectedRow();
RegistrosResponsables.jTextField2.setText(jTable1.getValueAt(selectedRow, 0).toString());
RegistrosResponsables.jLabel1.setText(jTable1.getValueAt(selectedRow, 1).toString());
 }
    /**
   ...
   RegistroDirecciones.code.setEnabled(true);
        this.poder = ClasArea.are.get("regdirecc");
        JDialog pu = (JDialog) this.poder;
        pu.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GrillaDirecciones.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                GrillaDirecciones dialog = new GrillaDirecciones(new javax.swing.JFrame(), true);
